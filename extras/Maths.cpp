...
glm::mat4	cge::Maths::createTransformationMatrix(const glm::vec3 &translation, const glm::vec3 &rotation, float scale) {
...
glm::mat4	cge::Maths::createViewMatrix(const cge::Camera &camera) {
